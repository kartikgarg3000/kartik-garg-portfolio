...
import { Mail, MapPin, Phone, Github, Linkedin, Twitter, Instagram, Send, MessageSquare } from "lucide-react";
    ...
    <section className="py-24 max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
         ...
         >
            <div>
               ...
               <div className="space-y-6">
                  <div className="flex items-start gap-4">
                     <div className="w-12 h-12 rounded-lg bg-[#111] border border-slate-800 flex items-center justify-center shrink-0">
                        <Mail className="w-5 h-5 text-cyan-500" />
                     </div>
                     <div>
                        <p className="text-sm font-mono text-slate-500 mb-1">Email</p>
                        <a href="mailto:kartikgarg.cse.2025@gmail.com" className="text-white hover:text-cyan-500 transition-colors font-medium">kartikgarg.cse.2025@gmail.com</a>
                     </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                     ...
                     <div>
                        <p className="text-sm font-mono text-slate-500 mb-1">Phone</p>
                        <a href="" className="text-white hover:text-cyan-500 transition-colors font-medium"></a>
                     </div>
                  </div>
            ...
            <div>
               <h3 className="text-lg font-bold text-white mb-6">Follow Me</h3>
               <div className="flex gap-4">
                  {[
                     ...
                     <a key={i} href={href} target="_blank" className="w-12 h-12 rounded-lg bg-[#111] border border-slate-800 flex items-center justify-center text-slate-400 hover:text-white hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all">
         ...
         <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.5, delay: 0.4 }}
            className="bg-[#0a0b10] border border-slate-800 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden"
         >
             {/* Glow Effect */}
             <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-500/5 blur-[80px] -z-10" />

            <h3 className="text-2xl font-bold text-white mb-2">Send a Message</h3>
            <p className="text-slate-500 mb-8 text-sm">I'll get back to you within 24-48 hours.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
               <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                     ...
                     <input 
                        ...
                        className="w-full bg-[#111] border border-slate-800 rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-cyan-500/50 transition-colors"
                        value={formData.name}
               ...
               <div className="space-y-2">
                  ...
                  <div className="relative">
                     <select 
                        className="w-full bg-[#111] border border-slate-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-cyan-500/50 transition-colors appearance-none cursor-pointer"
               ...
               <div className="space-y-2">
                  ...
                  <textarea 
                     ...
                     className="w-full bg-[#111] border border-slate-800 rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-cyan-500/50 transition-colors resize-none"
