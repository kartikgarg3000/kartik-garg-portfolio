...
export function AboutCTA() {
  return (
    <section className="py-32 max-w-5xl mx-auto px-6">
      <div className="relative bg-gradient-to-b from-card-bg to-background border border-border rounded-3xl p-12 md:p-20 overflow-hidden text-center">
         ...
         >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
               <Link 
                  ...
                  className="px-8 py-4 bg-primary text-primary-foreground font-bold rounded-full hover:shadow-lg hover:shadow-sky-400/20 transition-all flex items-center gap-2 group"
               >
               ...
               <div className="flex items-center gap-2 px-6 py-4 border border-border rounded-full text-muted-foreground hover:text-foreground hover:border-foreground/50 transition-colors cursor-pointer">
